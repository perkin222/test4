let question_arr = ["Хто перший переможець ЧМ? ","Хто переміг на ЧМ у 2010 році?", "Хто найкращий бомбардир за всю історію?", "Хто більше всього перемагав на ЧМ?", "Хто більше разів був у фіналі ЧМ?"]
let a1_arr = ["Бразилія","Аргентина","Мірослав Клозе","Бразилія","Бразилія"]
let a2_arr = ["Уругвай","Іспанія","Роналду","Італія","Німеччина"]
let a3_arr = ["Франція","Нідерланди","Пеле","Франція","Франція"]
let a4_arr = ["Англія","Бразилія","Герд Мюллер","Англія","Італія"]
let answer_arr = ["Уругвай","Іспанія","Мірослав Клозе","Бразилія","Німеччина"]
